...
## Descripción
Este proyecto es una API REST desarrollada en Node.js con Express y MySQL para un sistema de numerología que incluye gestión de usuarios, membresías mensuales y generación de lecturas mediante IA simulada.
...
3. Configura la base de datos MySQL y ejecuta el script `database.sql`
